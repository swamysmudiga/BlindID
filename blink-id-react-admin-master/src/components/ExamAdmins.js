...
import AdminService from '../services/exam_admin.service'; 
...
const GroupAdmins = () => {
  ...
  const handleAddUser = async user => {
    try {
      ...
      await AdminService.create({ groupid: id, user_id:user.id }, token); // Pass the user object
  ...
  return (
    <div className="container">
      <h2>Exam - {groupDetails && groupDetails.name} - Admins</h2>
